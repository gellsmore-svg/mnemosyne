...
def human_step_name(step: str | None) -> str:
    return {
        ...
        "plan.parallel.branch": "Plan Parallel Branch",
        "plan.parallel.completed": "Plan Parallel Join Ready",
        ...
        "plan.retry.backoff": "Plan Retry Backoff",
        "plan.await.pending": "Plan Await Pending",
        "plan.await.satisfied": "Plan Await Satisfied",
        "plan.await.timeout": "Plan Await Timeout",
        "plan.service.tick": "Plan Service Tick",
        "plan.concurrent.branch": "Plan Concurrent Branch",
        "plan.concurrent.completed": "Plan Concurrent Completed",
        "plan.revision.mid_step": "Plan Mid-Step Revision",
