...
Status: V1 complete. The V1 boundary is defined in `docs/build-roadmap.md` as the local memory workbench release. The release-candidate smoke procedure is `docs/v1-release-candidate-smoke.md`. Release tag: `v1.0.0`.
...
| Full automated tests pass. | Done | Latest run: `481 passed`. | None. |
