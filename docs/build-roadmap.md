...
- CLI and FastAPI expose read-only per-node trust/temporal diagnostics for selected weighting profiles; these scores are explanatory only and do not affect retrieval ranking.
