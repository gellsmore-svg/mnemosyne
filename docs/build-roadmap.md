...
- output ingestion is captured only as a pending queue; graph insertion, endorsement, restart state node, traversal scoring, and REM consolidation are not started.
